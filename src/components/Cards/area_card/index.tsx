      ...
      <Link to={`/Area/${area.id}`}>
        <div className="relative flex flex-col rounded-md m_border bg-clip-border text-gray-700 shadow-md">
          <div
            ...
            className="relative  h-32 overflow-hidden bg-blue-gray-500 bg-clip-border text-white shadow-lg shadow-blue-gray-500/40 bg-gradient-to-r border-[#e2e2e220] border-b"
          ></div>
